...
|:-----------|:---------|:--------|:--------|:-------------|
|async       |`boolean` |`true`  |4.1.0    |If true, `walkTokens` functions can be async and `marked.parse` will return a promise that resolves when all walk tokens functions resolve.|
